...
\begin{document}
   ...
   \begin{lstlisting}[label={lst:acceptThread}, caption=AcceptThread class]
    ...
    This BroadcastReceiver is also responsible for triggering the alarm. When the incoming text contains capital X ('X') it gets the current alarm sound via RingtoneManager and uses MediaPlayer to loop it until it is acknowledged.
